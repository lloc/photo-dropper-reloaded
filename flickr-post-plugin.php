<?php
/*
Plugin Name: Photo Dropper Reloaded
Plugin URI: https://github.com/lloc/photo-dropper-reloaded
Description: PhotoDropper lets you easily add free Creative Commons licensed photos to your posts from Flickr with just a few simple clicks allowing you to create professional high quality posts that your readers will love.
Version: 1.0
Author: Photo Dropper Reloaded
...
function flickr_post_add_pages() {
	...
	add_options_page('PhotoDropper', 'PhotoDropper', 5, __FILE__, 'flickr_post_options_page');
}
				...
				<tbody>
					<tr valign="top">
						...
						<td>
							...
							(If checked, the PhotoDropper interface will be located under the post and not as a media button)
						</td>
					</tr>
				</tbody>
			</table>
...
?>
	<div id="flickr-insert-widget" style="border: 1px solid #cccccc;" class="postbox">
		<h3 class="dbx-handle">PhotoDropper Browse Photos</h3>
...
class PDMediaPanel {
	...
	function addMediaButton() {
        ...
        $flickr_title = 'Add Photo via PhotoDropper';
